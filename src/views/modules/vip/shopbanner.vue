  ...
  <el-card shadow="never" class="aui-card--fill">
    <div class="mod-vip__shopbanner}">
      ...
      <el-table v-loading="dataListLoading" :data="dataList" border @selection-change="dataListSelectionChangeHandle" style="width: 100%;">
        ...
        <el-table-column prop="shopId" label="所属商户ID" header-align="center" align="center"></el-table-column>
        <el-table-column prop="title" label="banner标题" header-align="center" align="center"></el-table-column>
        <el-table-column prop="imageUrl" label="banner图片" header-align="center" align="center"></el-table-column>
