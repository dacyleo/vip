  ...
  <el-card shadow="never" class="aui-card--fill">
    <div class="mod-vip__eatkey}">
      <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
        ...
        <el-form-item>
          <el-button v-if="$hasPermission('vip:eatkey:save')" type="primary" @click="addOrUpdateHandle()">{{ $t('add') }}</el-button>
        </el-form-item>
        <el-form-item>
          <el-button v-if="$hasPermission('vip:eatkey:delete')" type="danger" @click="deleteHandle()">{{ $t('deleteBatch') }}</el-button>
        </el-form-item>
      </el-form>
...
import AddOrUpdate from './eatkey-add-or-update'
export default {
  mixins: [mixinViewModule],
  data () {
    return {
      mixinViewModuleOptions: {
        getDataListURL: '/vip/eatkey/page',
        getDataListIsPage: true,
        exportURL: '/vip/eatkey/export',
        deleteURL: '/vip/eatkey',
        deleteIsBatch: true
      },
      dataForm: {
        id: ''
