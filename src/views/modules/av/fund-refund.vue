...
<!--                <el-table-column prop="id" label="ID" header-align="center" align="center"></el-table-column>-->
                <el-table-column prop="orderNo" label="订单编号" header-align="center" align="center"   width="180" fixed></el-table-column>
...
<!--                                 align="center" width="140"></el-table-column>-->
                ...
                <el-table-column prop="asApplyTime" label="申请时间" header-align="center" align="center"  width="180"></el-table-column>
<!--                <el-table-column prop="asAuthTime" label="审核时间" header-align="center" align="center"></el-table-column>-->
                <el-table-column :label="$t('handle')" header-align="center" align="center" width="150" fixed="right">
                    <template slot-scope="scope">
                        <el-button v-if="$hasPermission('av:order:orderAudit') && scope.row.asStatus === 3" type="text" size="small" @click="addOrUpdateHandle(scope.row.id)">售后审核</el-button>
<!--                        <el-button v-if="scope.row.type === 1 && scope.row.payStatus === 2" type="text" size="small"-->
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                ...
                mixinViewModuleOptions: {
                    getDataListURL: '/av/order/pageRefund',
        ...
        methods: {
            getDataList2 () {
                this.page = 1
                if(this.asApplyTime && this.asApplyTime.length > 0){
